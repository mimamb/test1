    ...
    series: [
      {
        name: '金额：',
        type: 'pie',
        radius: ['40%', '60%'], // radius修改饼形图大小，第一个值是內圆半径，第二个值是外圆半径
        center: ["50%", "50%"],
        top: "0%",
    ...
    series: [
      {
        ...
        data: [
          { value: 30, name: '0-100㎡' },
          { value: 28, name: '100-200㎡' },
          { value: 26, name: '200-300㎡' },
          { value: 24, name: '300㎡以上' },
...
(function() {
  ...
  $.get('/map/科创区.json', function (geoJson) {
    ...
    //var myChart = echarts.init(document.getElementB('main'));
    myChart.hideLoading();
    var geoCoordMap = {
